...
The data was initially standardized, meaning the incidence of events for each racial group was aligned with their population proportion. Figure 2.1 reveals that "Other" and "Black" racial groups are the primary targets of police stop and search, with a notably higher frequency of "Arrest" and "Summons/charged by post", indicating a disproportionate focus on these groups. The chi-square test in Results 2.1 demonstrates a significant correlation (p < 0.05) between racial differences and the variability in search outcomes. 
...
Meanwhile, Figure 2.2 shows a preference for searching "White" individuals for items like "Crossbows", "Evidence of wildlife", etc. Result 2.2's chi-square test confirms a significant relationship between racial disparities and the intensity of searches.
